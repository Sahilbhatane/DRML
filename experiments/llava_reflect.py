...
"""
nlprun -m sphinx6 -g 1 -c 4 -r 40G -a sketch2code --output /sailhome/lansong/Sketch2Code/logs/llava_reflect_v0.3.txt 'python llava_reflect.py'
"""
    ...
    for _ in range(3):
        try:
            ...
            while turn < max_turns:
                ...
                agent_resp, history = llava_call(model, processor, feedback, sketch, history)
                print(f"agent: {agent_resp}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--out_dir', type=str, default='/juice2/scr2/nlp/pix2code/zyanzhe/sketch2code_eval/v0.2/llava_reflect')
