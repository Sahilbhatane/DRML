...
from utils.prompt_utils import get_reflection_message, get_direct_system_message, get_grounded_user_prompt, get_user_message_with_qa_pairs
from utils.utils import extract_html, remove_html_comments, read_html, extract_text_from_html, extract_feedback, gpt_cost, rescale_image_loader, load_internvl_image, cleanup_response, extract_title
from utils.screenshot import take_and_save_screenshot

"""
nlprun -m sphinx2 -g 1 -c 4 -r 80G -a sketch2code --output /sailhome/lansong/Sketch2Code/logs/internvl_direct_v0.2.txt 'python internvl2_direct.py'
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--out_dir', type=str, default='/juice2/scr2/nlp/pix2code/zyanzhe/sketch2code_eval/v0.2/internvl_direct')
